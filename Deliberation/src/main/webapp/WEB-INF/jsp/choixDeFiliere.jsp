					...
					<div class="form-row">
						...
						<div class="col-md-6">
							<div class="position-relative form-group">
								...
								<option value="1er semestre">S1</option>
								<option value="2eme semestre">S2</option>
								<option value="3eme semestre">S3</option>
								<option value="4eme semestre">S4</option>
								<option value="5eme semestre">S5</option>
								</select>
							</div>
						</div>
						</div>
