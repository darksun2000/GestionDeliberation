	...
	<layout:put block="content" type="REPLACE">
		...
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<button class="mb-3 mr-2  btn-transition btn btn-outline-dark" style="padding: 15px 100px;margin-top:20px"  onclick="window.location.href='ListInscriptionPedagogiqueM'">Liste Inscription par module (globale)</button>
				<button class="mb-3 mr-2  btn-transition btn btn-outline-dark"
				 style="padding: 15px 100px;margin-left:300px"  
				 onclick="window.location.href='ListInscriptionPedagogiqueMD'">
				 Liste Inscription par module (detailée)</button>
