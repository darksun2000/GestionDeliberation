			...
			<div class="card-body">
				...
				<form class="" action="/module/creer" method="POST">
						...
						<div class="col-md-6">
							<div class="position-relative form-group">
								<label for="name" class="">Nom du module</label><input
									name="name" id="name" placeholder="Nom du module"
							...
							<div class="position-relative form-group">
								...
								<select name="semestre_id" id="exampleSelect" class="form-control">
									<c:forEach var="semestre" items="${semestres }">
										<option value="${semestre.id_semestre}"> ${semestre.libelle_semestre } ${semestre.etape.filiere.nom_filiere}</option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="form-row">
						<div class="col-md-12">
							<div class="position-relative form-group">
								<label for="professeur_id" class="">Professeur résponsable:</label>
