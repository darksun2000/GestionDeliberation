			...
			<div class="col-md-3">
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<a href="/module/profile/${module.id_module }/element/liste"><button class="mb-2 mr-2 btn btn-primary btn-block">Les éléments du module</button></a>
			...
			<div class="col-md-9">
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<form action="/module/modifer/${module.id_module}"
							method="POST">
							...
							<button class="mt-1 btn btn-primary"
								formaction="/module/modifier/${module.id_module}" formmethod="POST">Modifier</button>
							<button class="mt-1 btn btn-danger"
								formaction="/module/supprimer/${module.id_module}" formmethod="POST">Supprimer</button>
